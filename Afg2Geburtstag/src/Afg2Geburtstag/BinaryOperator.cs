namespace Afg2Geburtstag
{
    ...
    public class BinaryOperator
    {
        ...
        public BinaryOperator(Func<ITerm, ITerm, BigRational?> evaluate, Func<ITerm, ITerm, string> operationToString, Func<ITerm, ITerm, string> operationToLaTeX)
        {
            Evaluate = evaluate;
