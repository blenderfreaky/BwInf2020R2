...
%\newcommand{\measure}[1]{\varphi_{d,b}(#1)}
...
%Ausgehend von Gleichung \ref{eqn:semi_accurate_bound}, kann für eine alternative Herleitung \(\measure{d}\) einfach durch \(\measure{d + d} = 2\cdot\measure{d}\) ersetzt werden. Es ergibt sich
...
%    \begin{align*}
%        t_{\measure{\frac{a}{b}}}
 %       &\in \mathcal{O}(n^{\frac{d+4}{\log_{20}(d)}} \cdot \underbrace{\big(\log_d(n) \cdot d\big)^{-\frac{3}{2}}}_{\text{streng monoton fallend}}) \\
...
%             4 & 2080 & \vspace{-0.6cm}\begin{dmath*} ((4 + 4) \cdot (4 + ({4}^{4}))) \end{dmath*}\vspace{-0.85cm} & 5 & 0.081s \\\hline
%             4 & 2020 & \vspace{-0.6cm}\begin{dmath*} (4 + ((({4}^{4}) - 4) \cdot (4 + 4))) \end{dmath*}\vspace{-0.85cm} & 6 & 0.086s \\\hline
%             5 & 2980 & \vspace{-0.6cm}\begin{dmath*} (5 - (5 \cdot (5 - (5 \cdot ((5 * (5 / 5))!))))) \end{dmath*}\vspace{-0.85cm} & 7 & 0.378s \\\hline
%             3 & 2080 & \vspace{-0.6cm}\begin{dmath*} ((((3 * 3) - 3)!) \cdot (3 - (\frac{3}{({3}^{3})}))) \end{dmath*}\vspace{-0.85cm} & 7 & 0.828s \\\hline
%             2 & 2020 & \vspace{-0.6cm}\begin{dmath*} (2 \cdot (2 - (((2 * 2)!) \cdot (2 - (2 \cdot 22))))) \end{dmath*}\vspace{-0.85cm} & 8 & 0.932s \\\hline
%             2 & 2980 & \vspace{-0.6cm}\begin{dmath*} (2 \cdot (2 + (2 \cdot (((2 * 2)!) + (((2 + 2) + 2)!))))) \end{dmath*}\vspace{-0.85cm} & 8 & 1.207s \\\hline
%             2 & 2080 & \vspace{-0.6cm}\begin{dmath*} (2 \cdot ((2 \cdot (22 - 2)) \cdot (2 + ((2 * 2)!)))) \end{dmath*}\vspace{-0.85cm} & 8 & 1.265s \\\hline
%             2 & 2030 & \vspace{-0.6cm}\begin{dmath*} ((2 + 2) - (22 - ({2}^{(22 / 2)}))) \end{dmath*}\vspace{-0.85cm} & 8 & 2.142s \\\hline
%             1 & 2020 & \vspace{-0.6cm}\begin{dmath*} ((1 + 1) \cdot (1111 \cdot (1 - (\frac{1}{11})))) \end{dmath*}\vspace{-0.85cm} & 10 & 3.046s \\\hline
%             5 & 2030 & \vspace{-0.6cm}\begin{dmath*} (5 - ((55 \cdot ((5 \cdot 5) - 5)) - ({5}^{5}))) \end{dmath*}\vspace{-0.85cm} & 8 & 3.955s \\\hline
%             8 & 2080 & \vspace{-0.6cm}\begin{dmath*} (\frac{(8 \cdot 8)}{(\frac{(8 + 8)}{(8 + (8 \cdot (8 \cdot 8)))})}) \end{dmath*}\vspace{-0.85cm} & 8 & 4.780s \\\hline
%             4 & 2030 & \vspace{-0.6cm}\begin{dmath*} (4 \cdot ((\frac{(({(4 + 4)}^{4}) - 4)}{(4 + 4)}) - 4)) \end{dmath*}\vspace{-0.85cm} & 8 & 5.457s \\\hline
%             4 & 2980 & \vspace{-0.6cm}\begin{dmath*} (4 \cdot ((((4 / 4) + 4)!) + ({(4 + (4 / 4))}^{4}))) \end{dmath*}\vspace{-0.85cm} & 8 & 5.613s \\\hline
%             1 & 2030 & \vspace{-0.6cm}\begin{dmath*} (({(1 + 1)}^{11}) + ((1 + 1) \cdot (1 - (11 - 1)))) \end{dmath*}\vspace{-0.85cm} & 10 & 6.910s \\\hline
%             1 & 2080 & \vspace{-0.6cm}\begin{dmath*} (({(1 + 1)}^{11}) - (1 - ((1 + (1 + 1)) \cdot 11))) \end{dmath*}\vspace{-0.85cm} & 10 & 6.913s \\\hline
%             0 & 2080 & \vspace{-0.6cm}\begin{dmath*} ((((((0!) + (0!)) + (0!))!)!) \cdot ((0!) - (({((0!) + ((0!) + (0!)))}^{(0 - ((0!) + (0!)))}) - ((0!) + (0!))))) \end{dmath*}\vspace{-0.85cm} & 23 & 8.147s \\\hline
%             5 & 2020 & \vspace{-0.6cm}\begin{dmath*} (({5}^{5}) - (5 + (55 \cdot ((5 \cdot 5) - 5)))) \end{dmath*}\vspace{-0.85cm} & 8 & 16.900s \\\hline
%             0 & 2020 & \vspace{-0.6cm}\begin{dmath*} (((0!) + (0!)) \cdot ((0!) + ((0!) - (\frac{((((((0!) + (0!)) + (0!))!) + (0!))!)}{((0!) - ((((0!) + (0!)) + (0!))!))})))) \end{dmath*}\vspace{-0.85cm} & 24 & 18.946s \\\hline
%             0 & 2980 & \vspace{-0.6cm}\begin{dmath*} (((0!) + (0!)) \cdot (((0!) + (0!)) \cdot ((0!) + ((((((0!) + (0!)) + (0!))!)!) + ((((0!) + (0!)) + ((0!) + (0!)))!))))) \end{dmath*}\vspace{-0.85cm} & 24 & 19.013s \\\hline
%     \end{longtable}
% \end{center}
